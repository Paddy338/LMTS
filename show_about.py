...
二次开发：裴启迪''',)
    ...
    link2_1.pack(padx=5, pady=5,side="left")
    link2_2=ttk.Button(link_frame2,
                       bootstyle='link',
                       text="仓库地址 (GitHub)",
                       command=lambda: webbrowser.open("https://github.com/Paddy338/LMTS",0))
    link2_2.pack(padx=5, pady=5,side="right")
    link_frame2.pack(padx=20, pady=20)
